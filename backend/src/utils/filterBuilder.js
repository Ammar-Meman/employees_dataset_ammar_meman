const buildEmployeeFilters = (query) => {
  ...
  if (query.verified !== undefined) {
    filters["profile.projects.tasks.assignedTo.skills.experience.certifications.meta.verified"] =
      query.verified === "true";
  }
  ...
  if (query.certification) {
    filters["$or"] = [
      ...
      {
        "profile.projects.tasks.assignedTo.skills.experience.certifications.expired":
          query.certification,
      },
    ];
  }
